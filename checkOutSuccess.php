...
<body>
    ...
    <center>
        <p style="font-size:30px; color:#66327F; font-weight: bold;">CONGRATULATIONS! YOUR ORDER WAS SUCCESSFULLY
            PLACED!</p>
        <a class="active" href="index.php">
            <p style="color:#66327F;">CLICK HERE TO RETURN HOME</p>
        </a>
        <a class="active" href="yourOrders.php">
            <p style="color:#66327F;">CLICK HERE TO VIEW YOUR ORDERS</p>
        </a>
    </center>
